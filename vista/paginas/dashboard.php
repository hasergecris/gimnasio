  ...
  <div class="row">
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
      <div class="position-sticky pt-3">
        ...
        <li class="nav-item">
            <a class="nav-link" href="index.php?pagina=login_usuario">
              Ingreso de Usuarios
            </a>
          </li>
         
          <li class="nav-item">
            <a class="nav-link" href="index.php?pagina=registro_usuario">
              Registro de Usuarios
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="index.php?pagina=lista_usuario">
              Lista Usuarios
            </a>
          </li>

          <li class="nav-item">
            <a class="nav-link" href="index.php?pagina=lista_pagos">
              Lista de Pagos
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="index.php?pagina=registro_pagos">
              Registro de Pagos
            </a>
          </li>
          <li class="nav-item">
